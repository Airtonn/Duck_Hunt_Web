...
function triggerGameOver() {
    ...
    const highScore = parseInt(localStorage.getItem('duck_hunt_record_level1') || '0', 10);

    if (currentScore > highScore) {
        localStorage.setItem('duck_hunt_record_level1', currentScore);
    }
...
function startNewGame() {
    ...
    spawnDogs(duckPos, 1, 7);                                // cria o cachorro na tela (vel reduzida)
